const productoQueries = {
  ...
  getAllSubCategorias: 'select idSubCategoria, idCategoria, nombreSubCategoria from subCategorias',
  crearSubCategoria: 'insert into subCategorias ( idCategoria, idSubCategoria, nombreSubCategoria) values ( ?, ?, ?)',
